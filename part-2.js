...
while(data[opCodeLoc] !== 99)
{
    ...
    switch(opCodeArray[4])
    {
        ...
        case '2':
            ...
            break;
        case '3':
            data[num1Loc] = parseInt(readline.question("Please enter the int: "));
            opCodeLoc+=2;
            break;
        case '4':
