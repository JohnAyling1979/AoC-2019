    ...
    for (let j = 0; j < edges2.length; j++) {
        ...
        if (edges1[i].type === 'h') {
            ...
            if(
                ...
                interections.push(Math.abs(edges2[j].point1.x) + Math.abs(edges1[i].point1.y));
            }
        } else {
            ...
            if(
                ...
                interections.push(Math.abs(edges1[i].point1.x) + Math.abs(edges2[j].point1.y));
            }
        }
    }
}
...
console.log('distance: ', interections[0]);
